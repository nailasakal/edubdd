...
function afterEachHandler(context) {
    ...
    const { testCaseStartedId, currentStepStartedAt, remainingSteps } = properties;
    ...
    if (remainingSteps.length > 0) {
        if (((_a = this.currentTest) === null || _a === void 0 ? void 0 : _a.state) === "failed") {
            ...
            for (const skippedStep of remainingSteps) {
                const testStepId = (0, assertions_1.assertAndReturn)((_h = (_g = skippedStep.hook) === null || _g === void 0 ? void 0 : _g.id) !== null && _h !== void 0 ? _h : (_j = skippedStep.pickleStep) === null || _j === void 0 ? void 0 : _j.id, "Expected a step to either be a hook or a pickleStep");
                taskTestStepStarted(context, {
                    testStepId,
                    testCaseStartedId,
                    timestamp: endTimestamp,
            ...
            for (const skippedStep of remainingSteps) {
                const testStepId = (0, assertions_1.assertAndReturn)((_l = (_k = skippedStep.hook) === null || _k === void 0 ? void 0 : _k.id) !== null && _l !== void 0 ? _l : (_m = skippedStep.pickleStep) === null || _m === void 0 ? void 0 : _m.id, "Expected a step to either be a hook or a pickleStep");
                taskTestStepStarted(context, {
                    testStepId,
                    testCaseStartedId,
                    timestamp: endTimestamp,
